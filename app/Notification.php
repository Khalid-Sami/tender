...
class Notification extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['request_id','s_ids', 'fk_i_actor_user_id', 'fk_i_notification_template_id', 'i_target_users_type', 'i_title_type', 's_title_en', 's_title_ar', 'i_action', 'b_enabled', 'dt_created_date', 'dt_modified_date', 'dt_deleted_date'];
    ...
    {
        return $this->belongsTo('App\Request', 's_ids', 'pk_i_id');
    }
