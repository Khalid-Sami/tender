...
class ServiceProvider extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['fk_i_subscription_package_id', 's_name_ar', 's_name_en', 's_company_name', 's_trade_license_no', 's_telephone_number', 's_mobile_number','s_fax', 's_email', 's_image', 's_address_ar', 's_address_en', 'd_longitude', 'd_latitude', 'i_status', 'b_enabled', 'dt_created_date', 'dt_modified_date', 'dt_deleted_date'];
    ...
    {
        return $this->hasMany('App\TSpService', 'fk_i_company_id', 'pk_i_id');
    }
    ...
    {
        return $this->hasMany('App\TSpUser', 'fk_i_company_id', 'pk_i_id');
    }

    public function tCompanyUsers()
    {
        return $this->hasMany('App\ServiceProviderUser', 'fk_i_service_provider_id', 'pk_i_id');
    }
