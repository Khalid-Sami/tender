...
//        $this->middleware(['locale']);
    ...
    public function showQuestionPage(Request $request)
    {
        ...
        $data['cId'] = $cId;
        $data['serviceName'] = ServiceQuestion::find($id)->service->s_service;
        ...
        return view('Question.question', $data)->with('service', $serviceCheck)->with('id', $id);
    }
...
//    }
    ...
    public function getQuestion(Request $request)
    {
        ...
        $id = intval($request['body']);
        return response()->json(['status' => 200, 'message' => ServiceQuestion::find($id)]);
    }
