...
<div class="content">
    ...
    @if(session('error_msg'))
        ...
        <h3 class="font-green">Service Provider Registration</h3>
        ...
        <h4 class="font-green">Service Provider Information</h4>
        <div class="form-group">
            {!! Form::label('service_provider_name_ar','Service Provider Name',['class'=>'control-label visible-ie8 visible-ie9']) !!}
            {!! Form::text('service_provider_name_ar', old('service_provider_name_ar'),['class' =>'form-control placeholder-no-fix','placeholder'=>'Service Provider (Arabic)']) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text('service_provider_name_en', old('service_provider_name_en'),['class' =>'form-control placeholder-no-fix','placeholder'=>'Service Provider']) !!}
