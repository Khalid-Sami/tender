...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('#myTable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{!! route('constant.get',['ConstantView','COUNTRIES']) !!}"
                },
                "columns": [
                    {
                    ...
                    {data: 's_name', name: 's_name',defaultContent:""},
                    {
                        ...
                        mRender: function (data, type, row, full) {
                            return '<div class="dropdown">' +
                                    ...
                                    '<li>' +
                                    '<a class="edit_country">@lang('lang.edit_country')</a>' +
                                    ...
                                    '</li>' +
                                    '<li>' +
                                    '<a href="/admin/' + row['pk_i_id'] + '/city">@lang('lang.show_city')</a>' +
                                    '</li>' +
                                    '</ul>' +
                                    '</div>';
    ...
    <script>
        $('body').on('click', '.edit_country', function () {
            ...
            $('#country_ar').val(s_name_ar);
            $('#country_en').val(s_name_en);
            $('#c_pk_i_id').val(pk_i_id);
            $('#country_status').val(status);
            $('#country_status').select2();
            $('#showCountry').modal('show');
        });
    </script>
    <script>
