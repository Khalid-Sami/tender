    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#myTable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('table.get','getServiceProviderUpdates') }}"
                },
                "columns": [
                    {
                    ...
                    {data: 's_email', name: 's_email',defaultContent:""},
                    {
                        mRender: function (data, type, row) {
                            return '<a  href="' + BASE_URL + '/admin/service/' + row['pk_i_id'] + '/update" class="btn btn-success view" data-toggle="modal" data-target="#myModal"> @lang('lang.view')</a>';
