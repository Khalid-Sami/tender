...
@section('content')
    ...
    <div class="col-sm-12">
        {!! Form::open(['id' =>'sendData','method'=>'get','action' =>['MainController@getTableData','getServiceProvider']]) !!}

        <div class="row">

            <div class="form-group col-sm-3">
                {!! Form::label('service_provider',trans('lang.service_provider')) !!}
                {!! Form::text('service_provider',null,['class' =>'form-control','id'=>'serviceProviderForm']) !!}
            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            {!! Form::label('clinic',trans('lang.service_provider')) !!} <span
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click', '#getDataTable', function () {
                var i = 1;
                var serviceProviderForm = $('#serviceProviderForm').val();
                var status = $('#statusForm').val();
                if (serviceProviderForm != "" && serviceProviderForm != null || status.length != "") {
                    ...
                    $('#myTable').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            "url": "{{ route('table.get','getServiceProvider') }}",
                            "data":{service_provider:serviceProviderForm,status:status,defaultContent:""}
