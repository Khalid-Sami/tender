            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style=" {{ $style['email-masthead'] }}">
                        <img style="float: left" src="{{url('/')}}/images/logo.png" alt="Website Logo">
                                                    ...
                                                    <table align="center" width="570"
                                                        ...
                                                        <tr>
                                                            @if( isset($data->get('website_url')->s_value))
                                                                <td>
                                                                    <a href="{{ url('/').$data->get('website_url')->s_value}}">Website
                                                                        Url</a></td>
                                                            @endif
                                                            @if( isset($data->get('facebook_url ')->s_value))
                                                                <td>
                                                                    <a href="{{ url('/').$data->get('facebook_url ')->s_value}}"><img
                                                                                width="24" height="24"
                                                            ...
                                                            @if( isset($data->get('twitter_url')->s_value))
                                                                <td>
                                                                    <a href="{{ url('/').$data->get('twitter_url')->s_value}}"><img
                                                                                width="24" height="24"
