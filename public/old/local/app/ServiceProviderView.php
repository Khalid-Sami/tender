...
{
    protected $table = 'v_service_provider';
    ...
    {
        return $this->hasMany('App\SPServices', 'fk_i_service_provider_id', 'pk_i_id');
    }
    ...
    {
        return $this->hasMany('App\SpUser', 'fk_i_service_provider_id', 'pk_i_id');
    }
