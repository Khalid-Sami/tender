...
class ServiceProviderUser extends Model
{
    ...
    public static function createServiceProviderUser($service_provider_id, $user_id)
    {
    ...
    {
        return $this->belongsTo('App\ServiceProvider', 'fk_i_service_provider_id', 'pk_i_id');
    }
