					...
					<div class="flex-row ">
						...
						<div class="flex-shrink flex-columns">
							...
							<a class="navbar-logo" href="index.html">
								<img src="unspecified.jpg" alt="Logo" />
							</a>
							...
							<div class="pull-right">
								...
								<div class="navbar-mini pull-left">
									...
									<ul class="clearfix">
										...
										<li class="add-list">
											<a href="#">Become A Professional <i class="fa fa-plus-circle"></i></a>
										</li>
										<li class="login">
					...
					<div class="row gap-40">
						...
						<div class="col-xs-12 col-sm-8 col-md-9">
							...
							<div class="blog-wrapper">
								...
								<div class="blog-extra">
									<div class="row">
										...
										<div class="col-xs-12 col-sm-12 col-md-5">
											<ul class="social-share-sm mt-5 pull-right pull-left-sm mt-20-xs">	
												...
												<li class="the-label"><a href="#">Google+</a></li>
								...
								<div class="section-title text-left mt-50">
								...
								<div class="blog-author clearfix">
									...
									<div class="author-details">
										...
										<h6><a href="#" class="inverse">Melissa Tonner</a></h6>
									...
									<ul class="sidebar-post">
										...
										<li class="clearfix">
											<a href="blog-single.html">
												...
												<div class="content">
													<h6>Year well shot deny shew come now had.</h6>
						...
						<div class="row">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3">
								...
								<div class="footer-social">
									...
									<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Google Plus"><i class="fa fa-google-plus"></i></a>
