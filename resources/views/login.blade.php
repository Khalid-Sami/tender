...
<div class="content">
    ...
    @if(session('resend'))
        ...
        @if(session('blockUser'))
            <div class="alert alert-danger alert-dismissible">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                {{ session('blockUser') }}
                <cite>{{session('email')}}</cite>
            </div>
        @endif
        ...
        <div class="form-group">
            ...
            {!! Form::text('email', null,['class' =>'form-control placeholder-no-fix','placeholder'=>'Email','autocomplete' => 'on']) !!}
            @if($errors->has('email'))
...
{{--            {!! Form::token() !!}--}}
            ...
            {{--<a href="{{route('auth.login','google')}}" class="btn"><i class="fa fa-google" aria-hidden="true"></i> Google</a> | --}}
            {{--<a href="{{route('auth.login','facebook')}}" class="btn"><i class="fa fa-facebook"></i> Facebook</a>--}}
        {{--</div>--}}
        <div class="create-account">
            <p>
                <a href="{{action('RegisterController@createServiceProvider')}}" id="register-btn" class="uppercase">Create an account</a>
            </p>
        </div>
