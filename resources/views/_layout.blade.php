...
@if(app()->getLocale() == 'ar')
    ...
    @if(app()->getLocale() == 'en')
        ...
        <head>
            <meta charset="utf-8"/>
            <title>@yield('head_title') {{ $title1 or '' }}</title>
            ...
            <div class="page-container">
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false"
                            ...
                            {{--<li class="nav-item">--}}
                            {{--<a href="{{route('rating.show')}}" class="nav-link nav-toggle">--}}
                            {{--<i class="fa fa-home"></i>--}}
                            ...
                            @endif
                            @if($user->userRule->s_name_en == 'ServiceProviderUser' && $user->b_enabled == "2")
                                <li class="nav-item">
                            ...
                            @if($user->userRule->s_name_en == 'SuperAdmin')
                                ...
                                <li class="nav-item">
                                    <a href="{{ action('AdminController@showAllProviders') }}" class="nav-link nav-toggle">
                                        <i class="fa fa-users"></i>
                                        <span class="title">@lang('lang.providers')</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item  ">
                                            ...
                                            <a href="{{action('MainController@getNotifications')}}"
                                ...
                                {{--<li class="nav-item">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">@lang('lang.company')</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item  ">
                                            <a href="{{ action('AdminController@Company') }}" class="nav-link ">
                                                <span class="title">@lang('lang.show')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item  ">
                                ...
                                <li class="nav-item">
                                <a href="{{ action('AdminController@showCategories') }}" class="nav-link nav-toggle">
                                    <i class="icon-wallet"></i>
                                    <span class="title">@lang('lang.managementCategories')</span>
                                </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">@lang('lang.servicesAnItems')</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item  ">
                                            {{--<a href="{{route('admin.notifications.send')}}" class="nav-link ">--}}
                                            <a href="{{action('AdminController@showItems')}}"
                                               class="nav-link nav-toggle">
                                                <i class="fa fa-television"></i>
                                                <span class="title">@lang('lang.show')</span>
                                            </a>
                                        ...
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@newItem')}}" class="nav-link ">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">@lang('lang.newItems')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                {{--<li class="nav-item">--}}
                                    {{--<a href="{{ action('AdminController@constantManagement') }}" class="nav-link nav-toggle">--}}
                                        {{--<i class="fa fa-plus-square-o"></i>--}}
                                        {{--<span class="title">@lang('lang.constant_management')</span>--}}
                                    {{--</a>--}}
                                {{--</li>--}}
                                <li class="nav-item">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                    ...
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@unitsItemsManagement')}}" class="nav-link ">
                                                <i class="fa fa-barcode"></i>
                                                <span class="title">@lang('lang.itemsUnit')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@itemsTypeManagement')}}" class="nav-link ">
                                                <i class="fa fa-book"></i>
                                                <span class="title">@lang('lang.itemsType')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@currenciesManagement')}}" class="nav-link ">
                                                <i class="fa fa-money"></i>
                                                <span class="title">@lang('lang.currencies')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">@lang('lang.tender_management')</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@newTender')}}" class="nav-link ">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">@lang('lang.newTender')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@allTenders')}}" class="nav-link ">
                                                <i class="fa fa-bullhorn"></i>
                                                <span class="title">@lang('lang.tenders')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">@lang('lang.offers')</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item">
                                            <a href="{{action('AdminController@showOffers')}}" class="nav-link ">
                                                <i class="fa fa-hourglass"></i>
                                                <span class="title">@lang('lang.offersProvided')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">@lang('lang.ReverseAuction')</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@newReverseAuction')}}" class="nav-link ">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">@lang('lang.newReverseAuction')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{action('AdminController@reverseAuctions')}}" class="nav-link ">
                                                <i class="fa fa-level-up"></i>
                                                <span class="title">@lang('lang.auctions')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">@lang('lang.reports')</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item  ">
                                            <a href="{{action('AdminController@tenderReport')}}" class="nav-link ">
                                                <i class="fa fa-bullhorn"></i>
                                                <span class="title">@lang('lang.tenders')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ action('AdminController@supplierReport') }}" class="nav-link nav-toggle">
                                                <i class="fa fa-users"></i>
                                                <span class="title">@lang('lang.providers')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{action('AdminController@offerReport')}}" class="nav-link ">
                                                <i class="fa fa-hourglass"></i>
                                                <span class="title">@lang('lang.offers')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{action('AdminController@winnerReport')}}" class="nav-link ">
                                                <i class="fa fa-users"></i>
                                                <span class="title">@lang('lang.winnersOffers')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                            @if($user->userRule->s_name_en == 'ServiceProviderAdmin' && $user->b_enabled == "2")
                                ...
                                <li class="nav-item  ">
                                    <a href="{{action('ServiceProviderController@getTenders')}}" class="nav-link ">
                                        <i class="fa fa-bullhorn"></i>
                                        <span class="title">@lang('lang.tenders')</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item  ">
                                    <a href="{{action('ServiceProviderController@spReverseAuctions')}}" class="nav-link ">
                                        <i class="fa fa-plus"></i>
                                        <span class="title">@lang('lang.ReverseAuction')</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu" style="display: none;">
                                        <li class="nav-item">
                                            <a href="{{action('ServiceProviderController@getAllOffers')}}" class="nav-link ">
                                                <i class="fa fa-hourglass"></i>
                                                <span class="title">@lang('lang.offersProvided')</span>
                                            </a>
                                        </li>
                                        <li class="nav-item  ">
                                            <a href="{{action('ServiceProviderController@newOffer')}}" class="nav-link ">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">@lang('lang.newOffer')</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                {{--<li class="nav-item">--}}
                                    {{--<a href="{{ action('ServiceProviderController@showAllUsers') }}"--}}
                                       {{--class="nav-link nav-toggle">--}}
                                        {{--<i class="fa fa-users"></i>--}}
                                        {{--<span class="title">@lang('lang.users')</span>--}}
                                    {{--</a>--}}
                                ...
                                {{--<li class="nav-item">--}}
                                    {{--<a href="{{ action('ServiceProviderController@messageIndex') }}"--}}
                                       {{--class="nav-link nav-toggle">--}}
                                        {{--<i class="fa fa-bullhorn"></i>--}}
                                ...
                                {{--<li class="nav-item">--}}
                                    {{--<a href="{{ action('ServiceProviderController@showServices') }}"--}}
                                       {{--class="nav-link nav-toggle">--}}
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        @if($user->b_enabled == "1")
{{--                            @if(session('managementApprovalMSG'))--}}
                                <div class="alert alert-danger alert-dismissible" style="text-align: center">
                                    {{--<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>--}}
                                    {{--{{ session('managementApprovalMSG') }}--}}
                                    {{ trans('lang.managementApproval') }}
                                </div>
                        @endif
                            {{--@endif--}}
{{--                        @lang('lang.addServices')--}}
                        <!-- BEGIN PAGE HEADER-->
                        <!-- BEGIN PAGE TITLE-->
                        <h2 class="page-title">
                            @yield('title')
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> {{date('Y')}} &copy; Al Makassed Hospital all rights reserved
                </div>
        ...
        <script>
            ...
            var channel1 = pusher.subscribe('{{ session('user_id') }}');
            channel1.bind('auction', function(data) {
                        @if(app()->getLocale() == 'ar')
                             var message = "(مزاد عكسي) "+data.nameAr + " اضافت سعر في "+data.auction;
                        @else
                            var message = "(Auction) "+data.nameEn + " added price in "+data.auction;
                        @endif
                $.notify(message, {
            ...
            var channel2 = pusher.subscribe('{{ session('user_id') }}');
            channel2.bind('adoptAuction', function(data) {
                        @if(app()->getLocale() == 'ar')
                            var message = "(مزاد عكسي) تم اعتماد عرض سعر "+data.companyName + " في "+data.auctionName;
                        @else
                            var message = "(Auction) "+data.companyName + " offer was approved at "+data.auctionName;
                        @endif
