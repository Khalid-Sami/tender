                    ...
                    <table id="itemsTable" class="col-sm-12" border="1" cellspacing="0">
                        ...
                        @foreach($tenderProposal->tenderProposalItems as $key => $item)
                            <tr>
                                ...
                                <td class="itemTotal">{{ $item->tenderItems->i_quantity * $item->d_price }}</td>
                                <td>
                                    @if($item->b_is_different == 1)
                                        <input style="width: 60%; height: auto" type="checkbox" class="form-control isDiff" name="isDiff[]" value="{{ $item->fk_i_tender_item_id }}" checked>
                                    @else
                                        <input style="width: 60%; height: auto" type="checkbox" class="form-control isDiff" name="isDiff[]" value="{{ $item->fk_i_tender_item_id }}">
                                    @endif
                                </td>
                                <td><input name="notes[{{$key+1}}]" type="text" class="form-control" value="{{ $item->s_note }}">
                                    ...
                                    <input type="hidden" name="tenderItemID[{{$key+1}}]" value="{{ $item->fk_i_tender_item_id }}">
                                </td>
                            </tr>
                        @endforeach

                        @if(count($tenderItems))
                            <?php
                                $count=count($tenderProposal->tenderProposalItems)
                            ?>
                            @foreach($tenderItems as $item)
                                <tr>
                                    ...
                                    <td><input name="price[{{$count}}]" type="text" class="form-control priceInput" value=""></td>
                                    ...
                                    <td><input name="notes[{{$count}}]" type="text" class="form-control" value="">
                                        <input type="hidden" name="itemQuantity[{{$count}}]" value="">
                                        <input type="hidden" name="tenderItemID[{{$count}}]" value="{{ $item->pk_i_id }}">
                                    </td>
                                </tr>
                            @endforeach
                        @endif
